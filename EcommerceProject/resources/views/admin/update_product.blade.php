      ...
      @include('admin.header')
       ...
       <div class="div_center">
          ...
          <div class="div_design">
            ...
            <input class="text_color" type="number" name="quantity" placeholder="write a quantity" min="0" required="" value="{{$product->discount_price}}" >
          </div>
          <div class="div_design">
          ...
          <div class="div_design">
            ...
            <input type="submit" value="Update Product" class="btn btn-primary"> </div>
